...
class Finance extends Admin {
    ...
    public function bank() {
        ...
        builder('list')
                ...
                ->addAction('编辑', 'bank_edit', '<i class="iconfont icon-bianji"></i>', 'btn btn-success btn-sm')
                ->addAction('删除', 'bank_delete', '<i class="iconfont icon-shanchu"></i>', 'btn btn-danger btn-sm ajax-get confirm')
                ->build();
    ...
    public function category() {
        ...
        builder('list')
                ...
                ->addAction('编辑', 'category_edit', '<i class="iconfont icon-bianji"></i>', 'btn btn-success btn-sm')
                ->addAction('删除', 'category_delete', '<i class="iconfont icon-shanchu"></i>', 'btn btn-danger btn-sm ajax-get confirm')
                ->build();
    ...
    public function query() {
        ...
        builder('list')
                ...
                ->addItem('remark', '备注')
                ->addAction('撤消', 'finance/query_delete', '<i class="iconfont icon-chexiao"></i>', 'btn btn-warning btn-sm ajax-get confirm')
                ->build();
