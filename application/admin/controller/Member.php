...
class Member extends Admin {
    ...
    public function index() {
        ...
        builder('list')
                ...
                ->addAction('编辑', 'edit', '<i class="iconfont icon-bianji"></i>', 'btn btn-success btn-sm', '')
                ->addAction('删除', 'delete', '<i class="iconfont icon-shanchu"></i>', 'btn btn-danger btn-sm ajax-get confirm')
                ->build();
        return view();
    }
    ...
    public function group() {
        ...
        builder('list')
                ...
                ->addAction('编辑', 'group_edit', '<i class="iconfont icon-bianji"></i>', 'btn btn-success btn-sm', 'data-toggle="modal" data-target="#modal"')
                ->addAction('删除', 'group_delete', '<i class="iconfont icon-shanchu"></i>', 'btn btn-danger btn-sm ajax-get confirm')
                ->build();
        return view();
    }
