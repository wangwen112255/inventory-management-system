...
<div class="table-common">
    <form class="form-inline" action="{:url('log')}" method="get">
        ...
        <button type="submit" class="btn btn-primary input-small" title="查询银行"><i class="iconfont icon-sousuo"></i> 搜索</button>
        <a href="<?php echo url('log_clear') ?>" class='btn btn-danger ajax-get confirm'><i class='iconfont icon-shanchu'></i> 日志清理</a> 　
    </form>
</div>
<p>
