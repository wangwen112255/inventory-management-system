...
<body>
    <div class="container-fluid">
        <form id="forminventorysupplier" class="form-inline" action="{site 'statistics/company_returns/'.$py}" accept-charset="utf-8" method="get">
        ...
        <p>
            <small><i class="iconfont icon-wushuju"></i> 合计退货:<strong>{:array_sum($list.quantity)}</strong>个产品</small>
        </p>
        ...
        {else}
        <p>
            <small><i class="iconfont icon-wushuju"></i> 查询到了<strong>{$count}</strong>个退回记录，合计退货:<strong>{:array_sum($list.quantity)}</strong>个产品</small>
        </p>
        <div id="tablelist">
