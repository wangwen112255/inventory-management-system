...
<div class="table-common">
    <div class="left">
        <a data-toggle="modal" data-target="#modal" data-title="新增供应商" href="{:url('supplier_add')}" title="新增供应商" class="btn btn-default"><i class="iconfont icon-tianjia"></i> 新增供应商</a>
    </div>
    <div class="left">
